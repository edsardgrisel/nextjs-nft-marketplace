...
export default function RepayLoanModal({
    ...
    const handleRepaySuccessful = () => {
        dispatch({
            type: "success",
            message: "You successfully repaid the loan!",
            title: "Repaid",
            position: "topR",
        })
        onClose && onClose()
                ...
                <div className="p-2">
                    <div className="flex flex-col items-center gap-2">
                        <div style={{ fontWeight: "bold", fontSize: "larger" }}>
                            ...
                            {ethers.utils.formatEther(amountToRepay.toString()).toString()} ETH to
                            pay off this loan?
                        </div>
